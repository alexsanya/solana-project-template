...
export type MerkleTreeAccountDataArgs = MerkleTreeAccountData;

export function getMerkleTreeAccountDataSerializer(): Serializer<
...
> {
  ...
  ) as Serializer<MerkleTreeAccountDataArgs, MerkleTreeAccountData>;
}
